CREATE DATABASE IF NOT EXISTS `tiffin_eatery` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `tiffin_eatery`;
-- MySQL dump 10.13 Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: tiffin_eatery  
-- ------------------------------------------------------
...
INSERT INTO `food_items` VALUES (1,'Idly',5.00),(2,'Porotta',15.00),(3,'Kichadi',20.00),(4,'Masala dosa',35.00),(5,'Ghee Dosa',30.00),(6,'Rava Dosa',30.00),(7,'Chappathi',10.00),(8,'veg biriyani',30.00),(9,'onion dosa',35);
...
INSERT INTO `orders` VALUES (40,1,2,10.00),(40,2,1,15.00),(41,4,3,105.00),(41,6,2,60.00),(41,9,4,140.00);
/*!40000 ALTER TABLE `orders` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'tiffin_eatery'  -- Change the database name here
--
